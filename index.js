...
const testSumOfString = () => {
    try {
        ...
        assert.equal(
            sumOfString("2,3"),
            5,
            "Test Case 2  *** Sum of 2,3 should return 5 ***"
        )
        assert.equal(
            sumOfString("2,3,4,5,6,7,8,9,10,99"),
            (2 + 3 + 4 + 5 + 6 + 7 + 8 + 9 + 10 + 99),
            "Test Case 3 *** Sum of 2,3,4,5,6,7,8,9,10,99 should return 153 ***"
        )
        assert.throws(
            () => sumOfString("-1,1,-3"),
            Error,
            "negative numbers not allowed -1,-3",
            "Test Case 4 *** Negative numbers are not allowed ***"
        )
        assert.equal(
            sumOfString("2,3\n4"),
            9,
            "Test Case 5 *** Sum of 2,3,4 should return 9 ***"
        )
        assert.equal(
            sumOfString("//[*],2,3\n4"),
            9,
            "Test Case 6 *** Sum of 2,3,4 should return 9 ***"
        )
        assert.equal(
            sumOfString("1000,2000,3,4"),
            1007,
            "Test Case 7 *** Sum of 1000,2000,3,4 should return 1007 ***"
        )
        assert.equal(
            sumOfString("//[**],2**3\n4"),
            9,
            "Test Case 8 *** Sum of 2,3,4 should return 9 ***"
        )
        assert.equal(
            sumOfString("//[#],2#3\n4"),
            9,
        ...
        assert.equal(
            sumOfString("//[*][%]\n1*2%3"),
            6,
            "Test Case 9 *** Sum of 1,2,3 should return 6 ***"
        )
        assert.equal(
            sumOfString("//[***]\n1***2***3"),
            6,
            "Test Case 10 *** Sum of 1,2,3 should return 6 ***"
        )

        assert.equal(
            sumOfString("//[***][%%]\n1***2%%3"),
            6,
            "Test Case *** Sum of 1,2,3 should return 6 ***"
        )
